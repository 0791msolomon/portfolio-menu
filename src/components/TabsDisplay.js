  ...
  return (
    <div>
      <Tabs forceRenderTabPanel defaultIndex={1}>
        ...
        {/* DISPLAY FOR DINNER OPTION */}
        <TabPanel>
          <Tabs forceRenderTabPanel>
            {/* DIFFERENT DINNER OPTIONS */}
            <TabList>
              <Tab>{"Beef & Broccoli"}</Tab>
              <Tab>Cheeseburger</Tab>
              <Tab>Sirloin Steak</Tab>
              <Tab>Chicken Fajitas</Tab>
              <Tab>Chicken</Tab>
            </TabList>
            {/* DIFFERENT PANELS TO DESCRIBE VARIOUS OPTIONS */}
            <TabPanel>
              <p>
                Protagonist, from the 20th Century. Delivery boy. Many times
                great-uncle to Professor Hubert Farnsworth. Suitor of Leela.
            ...
            <TabPanel>
              ...
              <img
                ...
                src="https://dam.tgifridays.com/medias/sys_master/root/h7a/haa/8889131630622/35110-quarter-768x896.jpg"
                alt="Professor Hubert J. Farnsworth"
              />
            </TabPanel>
          </Tabs>
